      ...
      <main className="min-h-screen my-12 lg:my-24">
        <div className="container mx-auto px-2">
          ...
          <section className="flex flex-col-reverse lg:flex-row gap-6 lg:gap-0">
            <div className="w-full">Información de contacto</div>
            <div className="w-full">
              <div className="mb-4">
                <h3 className="font-bold text-2xl lg:text-3xl text-pink-600">Envíanos un mensaje por WhatsApp y haz tu pedido</h3>
              ...
              <form className=" bg-gradient-to-br from-pink-100 to-pink-200 flex flex-col gap-4 py-4 px-6 shadow-lg items-end rounded-lg">
                <div className="flex flex-col gap-2 w-full">
                  <label htmlFor="message" className="text-gray-800 font-bold text-lg tracking-wide">Mensaje</label>
                  <textarea
                    name="message"
                    id="message"
                    cols="30"
